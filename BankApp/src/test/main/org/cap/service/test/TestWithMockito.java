...
public class TestWithMockito {
	...
	public void test_withdraw() throws InsufficientBalanceException {
		...
		//Actual Logic
		Account receivedAccount=accService.withdraw(1001,1000.00);
				
		//Verify
		Mockito.verify(accountDao).findAccountById(1001);
		
		Assert.assertEquals(1000, receivedAccount.getAmount(),0.0);
	...
	public void test_Deposit() {
		...
		//Actual Logic
		Account receivedAccount=accService.deposit(1001,1000.00);
				
		//Verify
		Mockito.verify(accountDao).findAccountById(1001);
		
		Assert.assertEquals(3000, receivedAccount.getAmount(),0.0);
